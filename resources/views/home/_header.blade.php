    ...
    <div class="row bg-secondary py-1 px-xl-5">
        <div class="col-lg-6 d-none d-lg-block">
            <div class="d-inline-flex align-items-center h-100">
                ...
                <a class="text-body mr-3" href="">Destes</a>
            ...
            <div class="d-inline-flex align-items-center">
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                       <a href="http://127.0.0.1:8000/register"> <button class="dropdown-item" type="button">Kaydol</button></a>
                        <a href="http://127.0.0.1:8000/login"> <button class="dropdown-item" type="button">Oturum aç</button></a>
                    </div>
                </div>
